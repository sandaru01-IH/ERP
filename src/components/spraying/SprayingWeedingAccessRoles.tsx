...
import { Shield, Eye, CheckCircle, Edit, Package, ClipboardList } from 'lucide-react'

const roles = [
  {
    role: 'Directors / GM',
    icon: Eye,
    permissions: ['View risk + compliance dashboards'],
    color: 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400',
  },
  {
    role: 'Estate Manager',
    icon: CheckCircle,
    permissions: ['Approve spray programs', 'Approve chemical requests'],
    color: 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400',
  },
  {
    role: 'Superintendent / Spray Officer',
    icon: Edit,
    permissions: ['Plan', 'Supervise', 'Verify'],
    color: 'bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-400',
  },
  {
    role: 'Chemical Storekeeper',
    icon: Package,
    permissions: ['Full chemical stock control'],
    color: 'bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-400',
  },
  {
    role: 'Spray Operators / Weed Teams',
    icon: ClipboardList,
    permissions: ['Task execution', 'Checklist logging (mobile)'],
    color: 'bg-teal-100 dark:bg-teal-900/30 text-teal-700 dark:text-teal-400',
  },
]

export default function SprayingWeedingAccessRoles() {
  return (
