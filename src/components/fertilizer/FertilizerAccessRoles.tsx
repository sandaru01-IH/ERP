...
import { Shield, Eye, CheckCircle, Edit, ClipboardCheck, Package } from 'lucide-react'
...
const roles = [
  {
    ...
    icon: Eye,
    permissions: [
      'View costs + approvals (budgets / large requests)',
    ],
  ...
  },
  {
    ...
    icon: CheckCircle,
    permissions: [
      'Approve programs and requisitions',
    ],
    color: 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400',
  },
  {
    role: 'Superintendent / Agronomy Officer',
    icon: Edit,
    permissions: [
      'Create program',
      'Schedule',
...
export default function FertilizerAccessRoles() {
  return (
            ...
            >
              ...
              <ul className="space-y-2">
                {role.permissions.map((permission, permIndex) => (
                  <li key={permIndex} className="flex items-start gap-2 text-sm text-gray-700 dark:text-gray-300">
