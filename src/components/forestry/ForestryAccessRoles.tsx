...
import { Shield, Eye, CheckCircle, Edit, ClipboardList, User } from 'lucide-react'

const roles = [
  {
    role: 'Directors / GM',
    icon: Eye,
    permissions: ['View compliance', 'Timber revenue (if any)'],
    color: 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400',
  },
  {
    role: 'Estate Manager',
    icon: CheckCircle,
    permissions: ['Approve harvesting permits / projects'],
    color: 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400',
  },
  {
    role: 'Forestry Officer / Superintendent',
    icon: Edit,
    permissions: ['Operate inventory', 'Plans', 'Execution logs'],
    color: 'bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-400',
  },
  {
    role: 'Labour',
    icon: User,
    permissions: ['Assigned tasks only'],
    color: 'bg-teal-100 dark:bg-teal-900/30 text-teal-700 dark:text-teal-400',
  },
]

export default function ForestryAccessRoles() {
  return (
